...
5주차) 훈련장을 들어가면 가지고 있는 골드로 기본 능력치 및 기술들을 배울수 있게 해줍니다.
### 던전
6주차) 7. 던전 입구를 누르면 1층을 시작에서 시작, 8. 던접 입장시 왼쪽 위에는 현재 위치하고 있는 방을 표시해주고 갈수 있는 방을 보여준다, 9. 화면 아래에는 화살표를 보여줘 원하는 방으로 이동을 할 수 있게 해줍니다. 10. 방을 이동 하면 전투 or 상자 or 행상인이 확률 적으로 나온다.
