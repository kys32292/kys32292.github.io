...
2. 상점에 들어가면 6개 정도의 아이템과 주사위 숫자 3를 보여주고 옆에 주사위를 돌리는 칸에서 주사위를 돌린다음 나오는 숫자에 따라 
   1,2 = 10 ~ 0퍼 가격 상승, 3 = 정가, 4 ~ 6= 10 ~ 30% 할인
...
17. 가방을 누르면 들고 있는 소모품을 보여주고 해당 소모품을 눌르면 사용과 취소 창이 뜨며 사용을 누를시 해당 소모품의 효과를 얻을수 있고,
    취소를 누르면 그냥 아이템 창이 닫히게됩니다.
